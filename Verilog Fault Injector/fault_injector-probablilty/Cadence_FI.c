...
////////////////////////////////////////////////////////////////////////////////////////////////
//	FF 결함주입 시험을 위한 injection node 위치 등록설정
//
////////////////////////////////////////////////////////////////////////////////////////////////

char 	FF_fault_list[100][100] = {0};
int	FF_fault_loc  = 0;
int 	FF_fault_size = 0;
...
void fault_injection_check(vpiHandle h)
{
	...
	if(strcmp(vpi_get_str(vpiFullName , h), FF_fault_list[FF_fault_loc]) == 0)
	{
		// 여러개의 결함을 주입할 경우 첨자 값이 빠뀐다..
		fault_configuration_list[0].fault_handle =h;
...
{
      vpi_printf("\n\n ICARUS Fault Injection, from VPI.\n");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	while(1)
	{
		...
		if(ch == '\n')
		{
			...
			strcpy(FF_fault_list[FF_fault_size++], str);	
	...
	//FF_fault_loc = rand() % FF_fault_size;
	FF_fault_loc = 0;	

//	vpi_printf("--------------------> fault injection FF is : %s\n", FF_fault_list[FF_fault_loc]);
